      ...
      <div className="">
            ...
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  ...
                  <span className="ms-3" onClick={()=>setSec("Dashboard")}>Dashboard</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap" onClick={()=>setSec("Container")}>Container</span>
              ...
              <li>
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap" onClick={()=>setSec("Images")}>Images</span>
              ...
              <li>
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap" onClick={()=>setSec("Volume")}>Volume</span>
                </a>
              </li>
              <li>
                <a
        ...
        <div className="p-4 sm:ml-64">
          <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            Idhar section logic aayga  .

            {curSec=="Dashboard"?"Dashboard":""}
            {curSec=="Container"?<Container/>:""}
            {curSec=="Images"?"Images":""}
            {curSec=="Volumes"?"Volumes":""}
